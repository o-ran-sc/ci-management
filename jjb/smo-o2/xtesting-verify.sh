...
cd /tmp
git clone https://github.com/o-ran-sc/smo-o2
sleep 1
cd -
cp /tmp/smo-o2/tacker/tacker/tests/xtesting/requirements.txt .
pip install -r requirements.txt
git clone https://forge.etsi.org/rep/nfv/api-tests.git
cp -r /tmp/smo-o2/tacker/tacker/tests/xtesting/api-tests/SOL003/CNFDeployment ./api-tests/SOL003
cp -r /tmp/smo-o2/tacker/tacker/tests/xtesting/api-tests/SOL003/cnflcm ./api-tests/SOL003
cp -r /tmp/smo-o2/tacker/tacker/tests/xtesting/api-tests/SOL005/CNFPrecondition ./api-tests/SOL005
cp /tmp/smo-o2/tacker/tacker/tests/xtesting/testcases.yaml ./xtesting-py3/lib/python3.8/site-packages/xtesting/ci/
