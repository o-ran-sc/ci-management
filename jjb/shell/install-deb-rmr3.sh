...
for deb in "rmr_${ver}_amd64.deb" "rmr-dev_${ver}_amd64.deb"; do
    echo "Download RMR file ${deb}"
    wget --content-disposition "https://packagecloud.io/o-ran-sc/${repo}/packages/debian/stretch/${deb}/download.deb"
    echo "Install RMR file ${deb}"
    sudo dpkg -i ${deb}
done
